...
{:else}
	<div class="container mx-auto md:w-2/3 lg:w-1/2 mb-12 mt-12 grid place-items-center">
		<form
		...
		>
			...
			<div class="relative mb-4">
				<label for="directions" class="leading-7 text-sm md:text-lg text-gray-600">Directions</label
				>
